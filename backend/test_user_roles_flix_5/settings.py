"""
Django settings for test_user_roles_flix_5 project.
...
ROOT_URLCONF = 'test_user_roles_flix_5.urls'
...
WSGI_APPLICATION = 'test_user_roles_flix_5.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_user_roles_flix_5 API",
    "DESCRIPTION": "API documentation for test_user_roles_flix_5 App",
    "VERSION": "v1",
}
